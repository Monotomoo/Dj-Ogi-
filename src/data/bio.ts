...
export const bioEntries: BioEntry[] = [
  ...
  },
  {
    ...
    title: 'NO BORDERS',
    description:
      'From Lov.e in São Paulo to Factory in London, from Cinema in Kiev to Fabrik in Ostrava, from Los Angeles to Toronto to Ottawa, from Bogotá to Barcelona. Hard techno speaks every language. The passport fills up but the studio address stays the same — Rijeka, Croatia.',
  },
  {
    year: 2021,
    title: 'FIRST WAX',
